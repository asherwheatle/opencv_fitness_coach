...
GOOD_REP_SOUND_FILE = r"C:\Users\asher\OneDrive\Documents\GitHub\fitness_coachopencv\opencv_fitness_coach\soundeffects\correctbuzzer.mp3" # ⬅️ Make sure this file exists!
BAD_REP_SOUND_FILE = r"C:\Users\asher\OneDrive\Documents\GitHub\fitness_coachopencv\opencv_fitness_coach\soundeffects\wrongbuzzer.mp3"
...
def speak_async(text):
    ...
    if text in LAST_SPOKEN_FEEDBACK and (now - LAST_SPOKEN_FEEDBACK[text] < cooldown_time):
        # 🚫 Message is still on cooldown, so don't speak
        return
